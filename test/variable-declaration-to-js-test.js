...
suite('variable-declaration-to-js-test', () => {
  test('it can convert a typed variable', () => {
    ...
    const jsAst = variableDefinitionsToJS(variableAst, t.identifier('client'), t.identifier('variables'));

    const code = generate(jsAst).code;

    assert.equal(code, '[variables["var"] = client.variable("var", "Int")]');
  });
  ...
  test('it can convert a typed variable with a default', () => {
    ...
    assert.equal(code, '[variables["var"] = client.variable("var", "Boolean", true)]');
  });
  ...
  test('it can convert a non-null typed variable with a default', () => {
    ...
    assert.equal(code, '[variables["var"] = client.variable("var", "String!", "beans")]');
  });
  ...
  test('it can convert a list type variable', () => {
    ...
    assert.equal(code, '[variables["var"] = client.variable("var", "[Things]")]');
  });
  ...
  test('it can convert a list type variable with non-null elements', () => {
    ...
    assert.equal(code, '[variables["var"] = client.variable("var", "[AnEnumType!]")]');
  });
  ...
  test('it can convert a list type variable with non-null elements with a default', () => {
    ...
    assert.equal(code, '[variables["var"] = client.variable("var", "[AnEnumType!]", [client.enum("BEANS")])]');
  });
  ...
  test('it can convert a non-null list type variable with non-null elements', () => {
    ...
    assert.equal(code, '[variables["var"] = client.variable("var", "[SomeOtherType!]!")]');
  });
